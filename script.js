...
function dil(){
    ...
    if(dil==0){
        ...
        document.getElementById("Profil").setAttribute("src","java.png")
    }
    else if(dil==1){
        ...
        document.getElementById("Profil").setAttribute("src","python.jpg")
    }
    else if(dil==2){
        ...
        document.getElementById("Profil").setAttribute("src","JavaScript.jpg")
    }
    else if(dil==3){
        ...
        document.getElementById("Profil").setAttribute("src","C++.png")
    }
    else if(dil==4){
        ...
        sonuc.classList.add("C#");
        document.getElementById("Profil").setAttribute("src","Csharp.png")
    }
    console.log(dil)
}
